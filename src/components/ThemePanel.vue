...
const codeBgColor = ref(localStorage.getItem(STORAGE_KEYS.codeBg) || getThemeCodeBg())
const codeTextColor = ref(localStorage.getItem(STORAGE_KEYS.codeText) || getThemeCodeText())
